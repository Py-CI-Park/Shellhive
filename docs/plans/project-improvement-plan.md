...
- 🔄 **Phase 4 진행 중**
  ...
  - 4-3-e PR #33 `feat/extract-tab-manager` + PR #43 `feat/extract-tab-manager-interactions` 2차 완료
  ...
  - 4-4 PR #37 `feat/app-entrypoint-slim` + PR #45 `feat/extract-file-drag-drop` 2차 진행
- 🔄 **Phase 5 진행 중**
  - 5-1 PR #23 Git 패널 UI 확장(브랜치/로그/discard) 반영
  - 5-2 보강: Claude/AI IPC 등록 일치성 테스트(`ipc-registration.test.js`) 추가
  - 5-3 보강: 실코드 기반 테스트 74개로 확장 (`state/git-panel/error/settings/shortcuts/modals/tab-manager/split-pane/session/terminal/dom/drag-drop`)
